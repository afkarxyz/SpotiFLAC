...
export function DeezerIcon({ className = "w-4 h-4" }: PlatformIconProps) {
    return <svg viewBox="0 0 24 24" className={`${className}`}>
        <rect width="24" height="24" rx="4" fill="#A238FF"/>
        <g fill="#fff">
            <rect x="4" y="16" width="16" height="2.5" rx="0.5"/>
            <rect x="4" y="12.5" width="16" height="2.5" rx="0.5"/>
            <rect x="4" y="9" width="10" height="2.5" rx="0.5"/>
            <rect x="4" y="5.5" width="6" height="2.5" rx="0.5"/>
        </g>
    </svg>;
}
export function DeezerAvailabilityIcon({ className = "w-4 h-4" }: PlatformIconProps) {
    return <svg viewBox="0 0 24 24" className={`${className} fill-current`}>
        <rect x="1" y="16" width="22" height="3" rx="0.5"/>
        <rect x="1" y="11.5" width="22" height="3" rx="0.5"/>
        <rect x="1" y="7" width="14" height="3" rx="0.5"/>
        <rect x="1" y="2.5" width="8" height="3" rx="0.5"/>
    </svg>;
}
