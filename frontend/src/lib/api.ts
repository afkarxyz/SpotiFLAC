...
export async function fetchSpotifyMetadata(url: string, batch: boolean = true, delay: number = 1.0, timeout: number = 300.0, fetchGenre: boolean = true): Promise<SpotifyMetadataResponse> {
